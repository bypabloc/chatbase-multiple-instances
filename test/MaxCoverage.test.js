...
describe('Maximum Coverage Tests - 95% Target', () => {
  ...
  describe('Specific Uncovered Code Paths', () => {
    ...
    it('should cover saveBots function', () => {
      ...
      expect(localStorage.setItem).toHaveBeenCalledWith('chatbaseBots', JSON.stringify(testBots))
    })
    ...
    it('should cover updateButtonState error cases', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Button or bot not found. Button: false, Bot: false')
      ...
      expect(console.error).toHaveBeenCalledWith('Button or bot not found. Button: true, Bot: false')
    })
    ...
    it('should cover validateInstanceContainer with invalid container', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Container for bot test-bot not found in DOM during minimize')
    })
    ...
    it('should cover minimizeOtherInstances', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Minimizing previous visible instance: other-bot')
    })
