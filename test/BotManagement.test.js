...
describe('Bot Management Functionality', () => {
  ...
  describe('Adding Bots', () => {
    it('should add a new bot with complete data', async () => {
      ...
      await user.type(screen.getByTestId('bot-description-input'), 'Especialista en inversiones')
      await user.type(screen.getByTestId('bot-avatar-input'), 'https://example.com/carlos.jpg')
      ...
      expect(localStorage.setItem).toHaveBeenCalledWith('chatbaseBots', JSON.stringify([newBot]))
    })
  ...
  describe('File Import', () => {
    ...
    it('should handle malformed JSON', () => {
      ...
      expect(result).toBe(false)
      expect(alert).toHaveBeenCalledWith('Error al procesar el archivo JSON. Verifica que el formato sea válido.')
